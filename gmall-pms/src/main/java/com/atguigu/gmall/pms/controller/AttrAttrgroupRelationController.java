...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteByGidAndAttrId(@RequestBody List<AttrAttrgroupRelationEntity> relationEntities) {
        this.attrAttrgroupRelationService.remove(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id", relationEntities.get(0).getAttrId()).eq("attr_group_id", relationEntities.get(0).getAttrGroupId()));
