...
import com.atguigu.gmall.pms.AttrVO;
...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryByCidTypePage(QueryCondition queryCondition, @RequestParam("cid") Long cid, @RequestParam("type") Integer type) {
